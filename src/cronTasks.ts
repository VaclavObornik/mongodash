...
export async function cronTask(taskId: TaskId, interval: Interval, task: TaskFunction): Promise<void> {
    ...
    // zajima me nebo ne z venku ze se cron uspesne zaregistroval?
    // chceme mit moznost na top level urovni awaitovat
    // chceme mit moznost na top level urovni ne-awaitovat?
}
